...
export const inputAvatarLink = document.querySelector('.popup__input_avatar_link');
export const formAvatar = document.querySelector('.popup__form_type_avatar');
export const popupEditAvatarButton = document.querySelector('.profile__edit-image');
